...
install:
	...
	cp platformer-178 $(BIN_PREFIX)
	chmod a+rx,g-w,o-w $(BIN_PREFIX)/platformer-178
	install -d $(MAN_PREFIX)/man/man6/
	cp  platformer-178.6 $(MAN_PREFIX)/man/man6/
	chmod a+rx,g-w,o-w $(MAN_PREFIX)/man/man6/platformer-178.6
